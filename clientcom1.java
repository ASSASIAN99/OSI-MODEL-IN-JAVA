...
import app.Socketssend.ImageButtonListener;
import app.Socketssend.KeysButtonListener;
import app.Socketssend.SentButtonListener;

public class clientcom1 extends JFrame implements HyperlinkListener {
		...
		ActionListener al = new ActionListener() {       
					public void actionPerformed(ActionEvent ae) {         
							try {           
										...
										e.printStackTrace();
										JOptionPane.showMessageDialog(clientcom1.this, "Browser problem: " + e.getMessage());         
							}       
					}     
		};     
